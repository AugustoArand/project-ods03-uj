<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            Atualize suas informações de conta e endereço de e-mail.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <p class="mt-1 text-sm text-gray-600">
            Atualize seus dados para uma experiência personalizada.
        </p>

        {{-- Campo de entrada para 'cigarros_por_dia_inicial' --}}
        <div>
            <x-input-label for="cigarros_por_dia_inicial" value="Cigarros por dia (inicial)" />
        ...
        <div>
            <x-input-label for="tempo_fumando_anos" value="Tempo fumando (anos)" />
        ...
        <div class="flex items-center">
            ...
            <x-input-label for="pratica_atividade_fisica" value="Pratica atividade física?" class="ml-2" />
            <x-input-error class="mt-2" :messages="$errors->get('pratica_atividade_fisica')" />
        </div>

        {{-- Campo de entrada para 'frequencia_semanal_exercicio' --}}
        <div>
            <x-input-label for="frequencia_semanal_exercicio" value="Frequência semanal de exercício (dias)" />
        ...
        <div>
            <x-input-label for="tempo_exercicio_minutos" value="Tempo de exercício por dia (minutos)" />
        ...
        {{-- Campo de entrada para 'objetivo_reducao' (agora como meta de tempo) --}}
        <div>
            <x-input-label for="objetivo_reducao" value="Meta de Tempo Livre de Cigarro (em dias)" />
            <x-text-input id="objetivo_reducao" name="objetivo_reducao" type="number" class="mt-1 block w-full" :value="old('objetivo_reducao', $user->userProfile->objetivo_reducao ?? 365)" autocomplete="off" />
            <x-input-error class="mt-2" :messages="$errors->get('objetivo_reducao')" />
            <p class="mt-1 text-sm text-gray-600">Defina sua meta pessoal em dias. Ex: 30 (1 mês), 90 (3 meses), 365 (1 ano).</p>
        </div>

        {{-- Campo de entrada para 'meta_cigarros_dia' --}}
        <div>
            <x-input-label for="meta_cigarros_dia" value="Meta de cigarros por dia" />
        ...
        <div>
            <x-input-label for="contato_emergencia_nome" value="Nome do Contato de Emergência" />
        ...
        <div>
            <x-input-label for="contato_emergencia_telefone" value="Telefone do Contato de Emergência" />
